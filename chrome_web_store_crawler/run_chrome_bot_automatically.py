...
while True:
    ...
    name_exported_file = '-time_[%s]' % completed_count
    ...
    name_exported_file_after_running_bot = 'chrome_web_store_crawler/chrome_data_analysis/data/chrome_ext_data' + name_exported_file
    ...
    print("Finished 8 latest months filter", file=open("log.txt", "a"))
    print("Exporting csvvvvvv....", file=open("log.txt", "a"))
    export_csv(y_1[1],name_exported_file_after_running_bot + name_exported_file + '.csv')
